                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control" value="{{$post->title}}" placeholder="Enter your post title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="checkbox" class="filled-in" id="status" name="status" value="1" {{$post->status==true?'checked':''}}>
